...
{
    public class AggressiveMode2 : IAggressiveMode
    {
        ...
        public AggressiveMode2(RpmShiftFactor rpmUpshiftFactor, IGearShifter gearShifter, IExternalSystems externalSystems)
        {
